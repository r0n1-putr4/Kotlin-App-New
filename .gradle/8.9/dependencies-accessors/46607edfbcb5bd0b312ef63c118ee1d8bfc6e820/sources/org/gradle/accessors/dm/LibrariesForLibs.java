...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final WasabeefLibraryAccessors laccForWasabeefLibraryAccessors = new WasabeefLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>wasabeef</b>
     */
    public WasabeefLibraryAccessors getWasabeef() {
        return laccForWasabeefLibraryAccessors;
    }
    ...
    public static class WasabeefLibraryAccessors extends SubDependencyFactory {
        private final WasabeefRicheditorLibraryAccessors laccForWasabeefRicheditorLibraryAccessors = new WasabeefRicheditorLibraryAccessors(owner);

        public WasabeefLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>wasabeef.richeditor</b>
         */
        public WasabeefRicheditorLibraryAccessors getRicheditor() {
            return laccForWasabeefRicheditorLibraryAccessors;
        }

    }

    public static class WasabeefRicheditorLibraryAccessors extends SubDependencyFactory {

        public WasabeefRicheditorLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>jp.wasabeef:richeditor-android</b> coordinates and
         * with version reference <b>richeditorAndroidVersion</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            return create("wasabeef.richeditor.android");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>imagepicker</b> with value <b>v2.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>richeditorAndroidVersion</b> with value <b>2.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getRicheditorAndroidVersion() { return getVersion("richeditorAndroidVersion"); }
